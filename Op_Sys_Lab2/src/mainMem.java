...
public class mainMem {
	...
	public static void main(String[] args) {
		...
		Scanner scan;
		File file = new File("/Users/admin/Desktop/CS/Op_Sys_Lab2/src/inputFile");
		try {
	...
	public static void getMT(MMT[] mmt)
	{
	...
	public static void count(ArrayList<Job> j, HashMap<Integer, Boolean> mem)
	{
		Job temp;
		int am;
